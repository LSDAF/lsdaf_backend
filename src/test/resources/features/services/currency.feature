Feature: Currency Service tests
  ...
  Scenario: Get Currency with cache
    ...
    And the following game saves
      ...
      | f81b710d-3e02-4871-a86f-390377798dd1 | 9b274f67-d8fd-4e1a-a08c-8ed9a41e1f1d | 5630280 | 0       | 0       | 0        | 500          | 1072   | 100          | 100      |
  ...
  Scenario: Set Currency without cache
    ...
    And I should have the following game saves in DB
      | id                                   | userId                               | gold | diamond | emerald | amethyst | healthPoints | attack | currentStage | maxStage |
      | f81b710d-3e02-4871-a86f-390377798dd1 | 9b274f67-d8fd-4e1a-a08c-8ed9a41e1f1d | 200  | 300     | 0       | 0        | 500          | 1072   | 100          | 100      |
