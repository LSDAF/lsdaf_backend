  ...
  public static Stream<User> sortUsers(Stream<User> userStream, UserOrderBy orderBy) {
    ...
    return switch (orderBy) {
      ...
      case CREATED_AT_DESC ->
          userStream.sorted(Comparator.comparing(User::getCreatedTimestamp).reversed());
      case NONE -> userStream;
    };
  }

  public static Stream<GameSaveEntity> sortGameSaves(
      Stream<GameSaveEntity> gameSaveStream, GameSaveOrderBy orderBy) {
    ...
    return switch (orderBy) {
      ...
      case CREATED_AT_DESC ->
          gameSaveStream.sorted(Comparator.comparing(GameSaveEntity::getCreatedAt).reversed());
      case UPDATED_AT -> gameSaveStream.sorted(Comparator.comparing(GameSaveEntity::getUpdatedAt));
      case UPDATED_AT_DESC ->
          gameSaveStream.sorted(Comparator.comparing(GameSaveEntity::getUpdatedAt).reversed());
      ...
      case GOLD ->
          gameSaveStream.sorted(
              Comparator.comparing(
                  gameSaveEntity -> gameSaveEntity.getCurrencyEntity().getGoldAmount()));
      case GOLD_DESC ->
          gameSaveStream.sorted(
              Comparator.comparing(
                      gameSaveEntity ->
      ...
      case DIAMOND ->
          gameSaveStream.sorted(
              Comparator.comparing(
                  gameSaveEntity -> gameSaveEntity.getCurrencyEntity().getDiamondAmount()));
      case DIAMOND_DESC ->
          gameSaveStream.sorted(
              Comparator.comparing(
                      gameSaveEntity ->
      ...
      case EMERALD ->
          gameSaveStream.sorted(
              Comparator.comparing(
                  gameSaveEntity -> gameSaveEntity.getCurrencyEntity().getEmeraldAmount()));
      case EMERALD_DESC ->
          gameSaveStream.sorted(
              Comparator.comparing(
                      gameSaveEntity ->
      ...
      case AMETHYST ->
          gameSaveStream.sorted(
              Comparator.comparing(
                  gameSaveEntity -> gameSaveEntity.getCurrencyEntity().getAmethystAmount()));
      case AMETHYST_DESC ->
          gameSaveStream.sorted(
              Comparator.comparing(
                      gameSaveEntity ->
      ...
      case NICKNAME_DESC ->
          gameSaveStream.sorted(Comparator.comparing(GameSaveEntity::getNickname).reversed());
      case MAX_STAGE ->
          gameSaveStream.sorted(
              Comparator.comparing(
                  gameSaveEntity -> gameSaveEntity.getStageEntity().getMaxStage()));
      case MAX_STAGE_DESC ->
          gameSaveStream.sorted(
              Comparator.comparing(
                      gameSaveEntity ->
