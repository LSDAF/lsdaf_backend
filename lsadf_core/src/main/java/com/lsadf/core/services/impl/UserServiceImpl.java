...
public class UserServiceImpl implements UserService {
    ...
    public User updateUser(String id, AdminUserUpdateRequest adminUpdateRequest) {
        ...
        try {
            ...
            if (userRoles != null && !userRoles.isEmpty()) {
                List<RoleRepresentation> roles = userRoles.stream()
    ...
    public User createUser(UserCreationRequest request) {
        ...
        if (checkUsernameExists(request.getUsername())) {
            throw new AlreadyExistingUserException("User with username " + request.getUsername() + " already exists");
        }


        // Create user
        UserRepresentation userRepresentation = mapper.mapUserCreationRequestToUserRepresentation(request);
    ...
    private UserRepresentation enrichUserRoles(UserRepresentation userRepresentation) {
        // Add roles to POJO
        List<RoleRepresentation> roles = getUsersResource().get(userRepresentation.getId()).roles().realmLevel().listAll();
