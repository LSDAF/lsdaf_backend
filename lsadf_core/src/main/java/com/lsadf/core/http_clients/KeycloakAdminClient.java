...
import com.lsadf.core.configurations.http_clients.KeycloakAdminFeignConfiguration;
...
@FeignClient(
    name = HttpClientTypes.KEYCLOAK_ADMIN,
    configuration = KeycloakAdminFeignConfiguration.class,
    primary = false)
public interface KeycloakAdminClient {
  ...
  default User getUserByUsername(
      @PathVariable(value = REALM) String realm, @RequestParam(value = USERNAME) String username) {
   ...
   */
  @PutMapping(
      path = SEND_VERIFY_EMAIL_ENDPOINT,
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
   ...
   */
  @PutMapping(
      path = EXECUTE_ACTIONS_EMAIL_ENDPOINT,
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  void sendActionsEmail(
      @PathVariable(value = REALM) String realm,
      @PathVariable(value = JsonAttributes.ID) String id,
  ...
  @PostMapping(
      ...
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  User createUser(@PathVariable(value = REALM) String realm, @RequestBody User user);
}
