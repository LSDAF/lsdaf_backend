...
import static com.lsadf.bdd.ParameterizedTypeReferenceUtils.buildParameterizedInventoryResponse;
...
public class BddInventoryWhenStepDefinitions extends BddLoader {
    ...
    @When("the user requests the endpoint to delete an item with id (.*) in the inventory of the game save with id (.*)$")
    public void when_the_user_requests_the_endpoint_to_delete_an_item_with_id_in_the_inventory_of_the_game_save_with_id(String itemId, String gameSaveId) {
