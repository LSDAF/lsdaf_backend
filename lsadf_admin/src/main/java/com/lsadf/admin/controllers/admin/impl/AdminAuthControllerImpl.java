...
public class AdminAuthControllerImpl extends BaseController implements AdminAuthController {
    ...
    public AdminAuthControllerImpl(KeycloakClient keycloakClient,
     ...
     */
    @Override
    public ResponseEntity<GenericResponse<JwtAuthentication>> login(@RequestBody @Valid UserLoginRequest
                                                                            userLoginRequest) {
     ...
     */
    @Override
    public ResponseEntity<GenericResponse<JwtAuthentication>> refresh(@RequestBody @Valid UserRefreshLoginRequest
