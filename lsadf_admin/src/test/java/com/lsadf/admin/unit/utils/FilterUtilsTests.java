...
class FilterUtilsTests {
    ...
    void test_equals_propertyStringFilter() {
        // Given
        Filter filter = generatePropertyStringFilter("firstName", "John", PropertyStringFilter.Matcher.EQUALS);
    ...
    void test_contains_propertyStringFilter() {
        // Given
        Filter filter = generatePropertyStringFilter("username", "smith", PropertyStringFilter.Matcher.CONTAINS);
    ...
    void test_date_greater_than_propertyStringFilter() {
        // Given
        Filter filter = generatePropertyStringFilter("createdTimestamp", "2021-01-01 00:00:00.000", PropertyStringFilter.Matcher.GREATER_THAN);
    ...
    void test_date_less_than_propertyStringFilter() {
        // Given
        Filter filter = generatePropertyStringFilter("createdTimestamp", "2022-01-01 00:00:00.000", PropertyStringFilter.Matcher.LESS_THAN);
    ...
    void test_andFilter() {
        // Given
        Filter filter1 = generatePropertyStringFilter("firstName", "John", PropertyStringFilter.Matcher.EQUALS);
        Filter filter2 = generatePropertyStringFilter("enabled", "true", PropertyStringFilter.Matcher.EQUALS);
     ...
     */
    private static PropertyStringFilter generatePropertyStringFilter(String propertyId, String filterValue, PropertyStringFilter.Matcher matcher) {
